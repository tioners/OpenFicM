...
模型文件不会提交到 Git。scripts/download-models.ps1 从 Hugging Face 下载以下文件并校验 SHA-256：
...
- 模型发现：读取供应商模型列表
- oh-story 更新：只读取正式 Release 和 13 个白名单 Markdown，绑定不可变 commit/tree SHA，不执行脚本或 Hook
